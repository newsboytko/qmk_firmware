...
[SYMB] = KEYMAP(
        ...
        // right hand
                                _____, _____, KC_LT, KC_GT, _____, _____, KC_GRV,
                                _____, KC_AMPR, KC_LCBR, KC_RCBR, KC_PLUS, KC_PERC, KC_TILD,
                                KC_EXLM, KC_LPRN, KC_RPRN, KC_EQL, KC_MINS, KC_UNDS,
                                _____, KC_PIPE, KC_LBRC, KC_RBRC, CPP_DEREF, KC_ASTR, KC_0,
                                _____, _____, _____, _____, _____,
        _____, _____,
        _____,
        _____, _____, _____
...
[NUMPAD] = KEYMAP(
        ...
        // right hand
                                _____, _____, KC_P7, KC_P8, KC_P9, KC_PSLS, KC_NLCK,
