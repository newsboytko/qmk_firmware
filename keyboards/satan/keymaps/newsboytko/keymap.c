...
void keymap_override_init(void)
{
    {
        /* Keymap common_layer_default_mac: overrides for default mac layer
          ...
          Foot switches:
                          ...
                          `--------'         `--------'
        */
        uint16_t keymap[MATRIX_ROWS][MATRIX_COLS] = KEYMAP_COMMON(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
        KC_X, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
        ...
        override_layer_keymap(common_layer_default_mac, keymap);
    }
}
