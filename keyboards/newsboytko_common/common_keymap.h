...
[common_layer_gui_windows] = KEYMAP_COMMON(\
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, LGUI(LSFT(KC_LEFT)), LGUI(LSFT(KC_RGHT)), _______, _______, _______, _______, _______, _______, \
...
[common_layer_gui_mac] = KEYMAP_COMMON(\
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, LCAG(KC_P), LCAG(KC_N), _______, _______, _______, _______, _______, _______, \
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
    _______, _______), \
\
