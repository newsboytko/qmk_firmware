...
[common_layer_default_windows] = KEYMAP_COMMON(\
      ...
      KC_LSFT,KC_NUBS,   KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,KC_COMM, KC_DOT,KC_SLSH,        TG(common_layer_numpad),            KC_UP,            KC_P1,  KC_P2,  KC_P3,KC_PENT, \
...
[common_layer_gui_windows] = KEYMAP_COMMON(\
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, M(common_macro_kvm1), M(common_macro_kvm2), LALT(KC_F4), _______, _______, _______, _______, _______, _______, _______, \
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, LCTL(LGUI(KC_LEFT)), LCTL(LGUI(KC_RGHT)), _______, _______, _______, _______, _______, _______, _______, _______, \
...
[common_layer_gui_mac] = KEYMAP_COMMON(\
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, LGUI(KC_W), _______, _______, _______, _______, _______, _______, _______, \
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, LCTL(KC_LEFT), LCTL(KC_RGHT), _______, _______, _______, _______, _______, _______, _______, _______, \
